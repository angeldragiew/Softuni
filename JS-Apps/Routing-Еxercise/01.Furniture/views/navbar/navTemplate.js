...
<nav>
    <a id="catalogLink" href="/dashboard" class=${ifDefined(navInfo.currentPage.startsWith('/dashboard') ? "active" :
    undefined)}>Dashboard </a>
    ${navInfo.isLoggedUser ?html`    <div id="user">
        ...
        <a id="loginLink" href="/login" class=${ifDefined(navInfo.currentPage.startsWith('/login') ? "active" :
            undefined)}>Login</a>
        <a id="registerLink" href="/register" class=${ifDefined(navInfo.currentPage.startsWith('/register') ? "active" :
